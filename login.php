...
<div class="login-box">
    ...
    <form method="post" action="login.php">
        ...
        <div class="form-group">
            <label for="username">Username: <br><input type="text" id="username" name="username" value="<?php echo isset($_POST['username']) ? h($_POST['username']) : ''; ?>" /></label>
            
        </div>
        
        <div class="form-group">
            <label for="password">Password: <br><input type="password" id="password" name="password" /></label>
            
        </div>
        
        <div class="form-group">
            <label>
                <input class="checkbox" type="checkbox" name="remember" <?php echo (isset($_POST['remember']) ? 'checked="checked"' : ''); ?> /> Remember me
            </label>
        </div>
